...
Add that code to the example above and you'll get a =timeoverlay= too. We'll talk more about [[https://gstreamer.freedesktop.org/documentation/application-development/basics/pads.html#ghost-pads]["ghost pads"]] later.
